...
llaveros2 = db.Table("pkg_llavero_batch2", meta, 
                Column("llave_mdm2", String(14), primary_key=True),
                Column("id_persona", String(14), ForeignKey("pkg_llavero_batch.llave_mdm")),
                Column("llave_crm", String(255)), 
                Column("llave_cif", String(255)), 
                Column("tipoid", String(20)), 
                Column("numeroid", String(255)), 
